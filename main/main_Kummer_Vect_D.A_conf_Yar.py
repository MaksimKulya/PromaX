...
# -----------------------------------------------------------------------------
z_ini=180+190; z = z_ini; zt = z_ini; prfx=0
...
# # diffraction
# z_gen=50+40; z = z_gen; zt = zt + z_gen; prfx=6
...
# # zz1_2 = np.linspace(F/2,F,2)
# # zz1_2 = [F/2]

# zz1_1 = np.linspace(0,38,2)
# zz1_2 = [95-38]
...
#     typo='compX';clim1=-1;clim2=1;norm=0
#     visual.Exy_t(EExf,t,X,Y,Nx,Ny,tmin,tmax,x_lim1,x_lim2,y_lim1,y_lim2,clim1,clim2,nu0,norm,c,zt,typo,path,prfx)
    
#     typo='compY';clim1=-1;clim2=1;norm=0
#     visual.Exy_t(EEyf,t,X,Y,Nx,Ny,tmin,tmax,x_lim1,x_lim2,y_lim1,y_lim2,clim1,clim2,nu0,norm,c,zt,typo,path,prfx)
    
#     typo='compZ';clim1=-0.1;clim2=0.1;norm=0
#     visual.Exy_t(EEzf,t,X,Y,Nx,Ny,tmin,tmax,x_lim1,x_lim2,y_lim1,y_lim2,clim1,clim2,nu0,norm,c,zt,typo,path,prfx)
