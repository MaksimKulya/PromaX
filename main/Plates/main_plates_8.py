...
path="D:\\SCIENCE\\2021\\RNF\\Apr\\pallet_2\\07.04\\evening"
...
(GG0x_qplate, GG0y_qplate) = Qplate.Qplate_360_1layer(path_qplate,GG0,X,Y,Nx,Ny,nu,GG0x_qwp,GG0y_qwp,del_b,h,angles)
retard_qplate = Qplate.efficency_1layer(path,GG0,X,Y,Nx,Ny,nu,h,angles)
...
typo='trans_x';prfx=3;x0;y0;tmin=N//2-100;tmax=N//2+100;x_lim1;x_lim2;y_lim1;y_lim2;clim1=-1;clim2=1;norm=0
visual.Exy_t(EE0x_qwp2,t,X,Y,Nx,Ny,tmin,tmax,x_lim1,x_lim2,y_lim1,y_lim2,nu0,norm,c,z,typo,path,prfx)
