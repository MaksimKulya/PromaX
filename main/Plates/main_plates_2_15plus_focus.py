...
path="D:\\SCIENCE\\2021\\RNF\\Apr\\10.04\\new_QWP6+our_Q+new_QWP6_15plus\\focus\\rho=25\\g\\1z"
...
typo='trans_y';prfx=5;norm=0
visual.FWHM_z(fwhm_2,norm,c,zz,path,typo,prfx)
np.save(path+'//'+ typo +'//'+'FWHM'+'//'+'fwhm_2.npy', fwhm_2)

typo='trans_y';prfx=6;norm=0
visual.FWHM_z(fwhm_2sum,norm,c,zz,path,typo,prfx)
np.save(path+'//'+ typo +'//'+'FWHM'+'//'+'fwhm_2sum.npy', fwhm_2)
