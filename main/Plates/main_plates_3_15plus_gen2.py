...
path="D:\\SCIENCE\\2021\\RNF\\Apr\\generation3\\new_QWP6\\g\\rho=30\\0deg"
...
# -----------------------------------------------------------------------------
z_ini=0; z = z_ini; zt = z_ini; prfx=0
...
# -----------------------------------------------------------------------------
z_plus=0; z = z_plus; zt = zt + z_plus; prfx=2
...
visual.E_xt(EEz,t,X,Nx,y0,t_lim1,t_lim2,x_lim1,x_lim2,clim1,clim2,nu0,norm,c,zt,path,typo,prfx)
# -----------------------------------------------------------------------------
z_plus=0; z = z_plus; zt = zt + z_plus; prfx=4
...
# # -----------------------------------------------------------------------------
# diffraction
z_gen=0; z = z_gen; zt = zt + z_gen; prfx=6
