...
path="D:\\SCIENCE\\2021\\RNF\\Apr\\09.04\\french+our_Q1+french\\s\\1z"
...
typo='trans_x';prfx=0;clim1=0;clim2=1;norm=0
...
typo='trans_y';prfx=0;clim1=0;clim2=1;norm=0
...
typo='trans_x';prfx=1;clim1=0;clim2=1;norm=0
...
del_b=12
(GG0x_qplate, GG0y_qplate) = Qplate.Qplate_r(path_qplate,GG0,X,Y,Nx,Ny,nu,GG0x_qwp,GG0y_qwp,del_b)
retard_qplate = Qplate.efficency(path_qplate,GG0,X,Y,Nx,Ny,nu) 

typo='trans_x';prfx=2;clim1=0;clim2=1;norm=0
...
typo='trans_x';prfx=3;clim1=0;clim2=1;norm=0
...
typo='trans_x';prfx=3;clim1=-1;clim2=1;norm=0
...
for i,z in enumerate(zzz1_1):
    ...
    typo='trans_y';prfx=5;clim1=-0.5;clim2=0.5;norm=0
    visual.Exy_t(EE,t,X,Y,Nx,Ny,tmin,tmax,x_lim1,x_lim2,y_lim1,y_lim2,clim1,clim2,nu0,norm,c,z,typo,path,prfx)
...
typo='trans_y';prfx=6;clim1=-0.5;clim2=0.5;norm=0
visual.Exy_t(EE0_2,t,X,Y,Nx,Ny,tmin,tmax,x_lim1,x_lim2,y_lim1,y_lim2,clim1,clim2,nu0,norm,c,z,typo,path,prfx)
...
for i,z in enumerate(zzz1_2):
    ...
    typo='trans';prfx=6;clim1=-0.5;clim2=0.5;norm=0
    visual.E_xt(EE,t,X,Nx,y0,t_lim1,t_lim2,x_lim1,x_lim2,clim1,clim2,nu0,norm,c,z,path,typo,prfx)
    
    typo='long';prfx=6;clim1=-0.05;clim2=0.05;norm=0
    visual.E_xt(EEz,t,X,Nx,y0,t_lim1,t_lim2,x_lim1,x_lim2,clim1,clim2,nu0,norm,c,z,path,typo,prfx)
