...
path="D:\\SCIENCE\\2021\\RNF\\Apr\\26.04\\new_QWP6+our_Q_L2+new_QWP6_15plus\\diffr\\rh0=15\\g\\p\\1z"
...
del_b=12
(GG0x_qplate, GG0y_qplate) = Qplate.Qplate_360(path_qplate,GG0,X,Y,Nx,Ny,nu,GG0x_qwp,GG0y_qwp,del_b,Lf=1) # Lf=1 -> L=2; Lf=2 -> L=1
