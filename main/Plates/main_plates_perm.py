...
path="D://SCIENCE//2021//test//Apr//2"
...
z=0
# 7 qwp
path_qwp = 'D:\\SCIENCE\\2021\\RNF\\plates\\waveplate_quarter_05-13.txt'
del_b=0
...
perm2 = permutations(angles)
perm2 = np.array(list(perm2))

np.set_printoptions(threshold=np.inf, linewidth=np.inf)  # turn off summarization, line-wrapping
with open(path + "\\" + "perm1.txt", 'w') as f:
    f.write(np.array2string(perm1, separator=', '))
    
    np.set_printoptions(threshold=np.inf, linewidth=np.inf)  # turn off summarization, line-wrapping
with open(path + "\\" + "perm2.txt", 'w') as f:
...
for i in range(perm1.shape[0]):
    ...
    (GG0x_qwp,GG0y_qwp) = QWP.QWP_perm(path,GG0,X,Y,Nx,Ny,nu,GG0x,GG0y,del_b,h,angles)
    # retard_qwp = QWP.efficency(path_qwp,GG0,X,Y,Nx,Ny,nu)        
    
    # typo='trans_x';prfx=i;y0;nu_lim1=0.01;nu_lim2=2.5;x_lim1;x_lim2;clim1=0;clim2=1;norm=0
    ...
    # typo='trans_y';prfx=i;y0;nu_lim1=0.01;nu_lim2=2.5;x_lim1;x_lim2;clim1=0;clim2=1;norm=0
    ...
    typo='trans_x';prfx=i;x0;y0;nu_lim1=0.01;nu_lim2=3;x_lim1;x_lim2;clim1=0;clim2=1;norm=0
...
# -----------------------------------------------------------------------------
# # Qplate
# path_qplate = 'D:\\SCIENCE\\2021\\RNF\\Mar\\plates\\waveplate_half_04-14_12deg.txt'
# del_b=12
...
# del_b=0
# (GG0x_qwp2,GG0y_qwp2) = QWP.QWP2_r(path_qwp,GG0,X,Y,Nx,Ny,nu,GG0x_qplate,GG0y_qplate,del_b)
# retard_qwp = QWP.efficency(path_qwp,GG0,X,Y,Nx,Ny,nu)        
