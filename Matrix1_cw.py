...
path="D://SCIENCE//2021//RNF//Mar//butch//Matrix3"
...
# GxGydiff0=(np.angle(GG0y[:,64,64])-np.angle(GG0x[:,64,64]))/pi

# -----------------------------------------------------------------------------
GG0x_cw=GG0[84,:,:]
GG0y_cw=np.zeros(shape=(GG0.shape[1], GG0.shape[2]), dtype=complex)

z=0
# # 7 qwp
path_qwp = 'D:\\SCIENCE\\2021\\RNF\\Mar\\waveplate_7_18_q2.txt'
theta=0
(GG0x_cw_qwp,GG0y_cw_qwp) = QWP.QWP1_1layer_cw(path_qwp,GG0,X,Y,Nx,Ny,nu[84],GG0x_cw,GG0y_cw,theta)      

delay_cw_1layer_qwp = QWP.efficency_1layer_cw(path_qwp,GG0,X,Y,Nx,Ny,nu[84])

GxGydiff=(np.angle(GG0y_cw_qwp[64,64])-np.angle(GG0x_cw_qwp[64,64]))/pi
...
# -----------------------------------------------------------------------------
# # Qplate
# path_qplate = 'D:\\SCIENCE\\2021\\RNF\\Mar\\half_good.txt'
# (GG0x_qplate, GG0y_qplate) = Qplate.Qplate(path_qplate,GG0,X,Y,Nx,Ny,nu,GG0x_qwp,GG0y_qwp)
...
# # # 7 qwp
# path_qwp = 'D:\\SCIENCE\\2021\\RNF\\Mar\\waveplate_7_18_q2.txt'
# (GG0x_qwp2,GG0y_qwp2) = QWP.QWP2(path_qwp,GG0,X,Y,Nx,Ny,nu,GG0x_qplate,GG0y_qplate)
...
# typo='trans_x';prfx=3;y0;numin=0;numax=200;x_lim1;x_lim2;y_lim1;y_lim2;clim1=0;clim2=1;norm=0
# visual.Axy_nu(GG0x_qwp2,nu,X,Y,Nx,Ny,numin,numax,x_lim1,x_lim2,y_lim1,y_lim2,nu0,G0,norm,c,z,typo,path,prfx)
# visual.PHxy_nu(GG0x_qwp2,nu,X,Y,Nx,Ny,numin,numax,x_lim1,x_lim2,y_lim1,y_lim2,nu0,G0,norm,c,z,typo,path,prfx)
