...
theta=0
(GG0x_qwp,GG0y_qwp) = QWP.QWP1(path_qwp,GG0,X,Y,Nx,Ny,nu,GG0x,GG0y,theta)
...
typo='trans_x';prfx=1;x0;y0;nu_lim1=0.3;nu_lim2=1.1;x_lim1;x_lim2;clim1=0;clim2=1;norm=0
visual.PHnu_xy_2gr(GG0x_qwp,GG0y_qwp,nu,X,Nx,x0,y0,nu_lim1,nu_lim2,nu0,G0,norm,c,z,path,typo,prfx)

GxGydiff=(np.angle(GG0x_qwp[59,64,64])-np.angle(GG0y_qwp[59,64,64]))/pi
